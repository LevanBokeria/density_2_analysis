...
knit: (function(input, ...) {
    rmarkdown::render(
      ...
      '/results/experiments/',
      'experiment_chose_sparse_paradigm_2_3_qc_filtered_',Sys.Date(),'.html'
...
print(paste0('Which experiment paradigm? ', which_experiment))
...
```{r mid-triplets-vs-zero-effect-size}
...
```{r mid-triplets-vs-zero-plot, fig.width=5, fig.height=4, warning=F}
