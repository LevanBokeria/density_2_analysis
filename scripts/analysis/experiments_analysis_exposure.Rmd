...
```{r same-trials, fig.height=5, fig.width=6}
...
same_resp_table_same_trials %>%
        ...
        ggtitle(paste0('Same trials: % Same response in session(s) ', paste(plot_which_session, sep = '_', collapse = '_')))

```

### Now for "different" trials 

```{r diff-trials, fig.height=5, fig.width=6}
