...
tt_participant_summary_stats_triplet_location_differences <- 
        tt_participant_summary_stats_triplet_location %>% 
...
```{r triplet-location-differences, fig.width=12, fig.height=6, warning=F}

x_font_size <- 10
x_font_angle <- 10

# Now plot this
fig1 <- tt_participant_summary_stats_triplet_location_differences %>%
        filter(dep_var_type == 'post_pre_diff',
...
# Now plot this
fig2 <- tt_participant_summary_stats_triplet_location_differences %>%
        filter(dep_var_type == 'post_pre_diff',
               chose_towards_type == 'chose_towards_sparse') %>% 
        ggplot(aes(x=difference_type,
                   y=difference_value)) +
...
# Now plot this
fig3 <- tt_participant_summary_stats_triplet_location_differences %>%
        filter(dep_var_type == 'post_pre_diff',
        ...
        # facet_wrap(~counterbalancing) +
        theme(axis.text.x = element_text(angle = x_font_angle)) + 
        ggtitle('Post-pre chose_towards_highdim. Diff scores')

# Now plot this
fig4 <- tt_participant_summary_stats_triplet_location_differences %>%
        filter(dep_var_type == 'post_pre_diff',
               chose_towards_type == 'chose_towards_highdim') %>% 
        ggplot(aes(x=difference_type,
                   y=difference_value)) +
...
```{r all-dep-var-curve-type-easiness-plots, fig.width=12, fig.height=12, warning=F}
...
```{r all-dep-var-triplet-location-template-easiness-plots, fig.width=12, fig.height=12, warning=F}
