...
% if flip triplets flip em!
if flip_space
    
    triplets.query = flip_value - triplets.query;
    triplets.ref1 = flip_value - triplets.ref1;
    triplets.ref2 = flip_value - triplets.ref2;
    
    % Distances 
    triplets.dist_query_ref1 = triplets.query - triplets.ref1;
    triplets.dist_query_ref2 = triplets.query - triplets.ref2;
    triplets.dist_ref1_ref2  = triplets.ref1 - triplets.ref2;
    
    triplets.abs_dist_query_ref1 = abs(triplets.dist_query_ref1);
    triplets.abs_dist_query_ref2 = abs(triplets.dist_query_ref2);
    triplets.abs_dist_ref1_ref2 = abs(triplets.dist_ref1_ref2);
end
